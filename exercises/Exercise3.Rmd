...
url_por <- paste("https://raw.githubusercontent.com/KimmoVehkalahti/Helsinki-Open-Data-Science/master/datasets", "student-por.csv", sep = "/")
...
- Define a new aesthetic element to the bar plot of `alc_use` by defining `fill = sex`. Draw the plot again.
